<?php
    ...
    $fetch = mysqli_query($conn, "SELECT * FROM ui_faci WHERE id = '$edit_id' LIMIT 1");
    ...
    if (isset($_POST['update'])) {
        ...
        // 🔥 FIX: POST इनपुट के नाम को फॉर्म के नए नाम (name, title, about) के अनुसार बदला
        ...
        $updateQuery = "UPDATE ui_faci SET  
                            title = '$Title',
                            about      = '$About',
                            avatar     = '$Avatar'
                        WHERE id       = '$edit_id'";
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text">
                                            ...
                                            <input type="text" class="form-control form-control-lg" name="about" placeholder="Enter about details..." value="<?php echo isset($row['about']) ? htmlspecialchars($row['about']) : ''; ?>" required>
                                    </div>
                                </div>
