				...
				<div class="container">
					<div class="row align-items-lg-center">
						...
						<div class="col-lg-auto col-lg-2 d-flex align-items-lg-center">
							<a href="<?php echo $base_url; ?>" ><img src="img/canossalogo1.png" alt="" style="width:208px; height: 50px;"></a>
						</div>
						...
						<div class="container">
							<div class="row">
								...
								<div class="col-sm-6 mt-5 mt-md-0 text-center text-md-right">
									...
									<a href="<?php echo $base_url; ?>" class="btn mt-2 mt-sm-3 mt-lg-4" data-toggle="modal" data-target="#modalBooking"><i class="icon-right-arrow"></i><span>Request an appointment</span><i class="icon-right-arrow"></i></a>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="footer-bottom">
				<div class="container">
					<div class="row text-center text-md-left">
						<div class="col-sm">Copyright © <?php echo date('Y');?> <a href="<?php echo $base_url; ?>" style="text-decoration:none;">Canossa Hospital.</a> All rights reserved.
						</div>
