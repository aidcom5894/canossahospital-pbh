<?php
    ...
    if (!isset($_GET['id']) || empty($_GET['id'])) {
        echo "<script>window.location.href = 'ui_team.php';</script>";
        exit();
    }
    ...
    $fetch = mysqli_query($conn, "SELECT * FROM ui_team WHERE id = '$edit_id' LIMIT 1");
    ...
    if (!$row) {
        ...
        echo "<script>setTimeout(function(){ window.location.href = 'ui_team.php'; }, 2000);</script>";
        exit();
    }
    ...
    if (isset($_POST['update'])) {
        ...
        // 🔥 FIX: POST इनपुट के नाम को फॉर्म के नए नाम (name, department, about) के अनुसार बदला
        $Heading  = mysqli_real_escape_string($conn, $_POST['name']);
        $Title    = mysqli_real_escape_string($conn, $_POST['department']);
        ...
        $updateQuery = "UPDATE ui_team SET  
                            name       = '$Heading',
                            department = '$Title',
                            avatar     = '$Avatar'
                        WHERE id       = '$edit_id'";
    ...
    <div class="container-fluid">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <div class="card p-3 w-100">
                <h6 class="fw-semibold mb-0"> Edit <span class="text-danger"> / </span> <span class="text-info fw-normal fs-5"> Team-Page </span></h6>
            </div>  
        </div>
                            ...
                            <form method="POST" class="form-valide-with-icon needs-validation" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label class="text-label form-label">Doctor-Name</label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control form-control-lg" name="department" placeholder="Enter Department..." value="<?php echo isset($row['department']) ? htmlspecialchars($row['department']) : ''; ?>" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="custom-btn-group">
                                    <button type="button" class="btn btn-outline-danger custom-wide-btn" onclick="window.location.href='ui_team.php'"> Cancel </button>
