...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    if ($delete) {
        // ठीक उसी तरह का बड़ा और परफेक्ट SweetAlert जैसा आपके ui_home के सबमिट में था
        echo "
        ...
        echo "<script>alert('Error deleting record: " . mysqli_error($conn) . "'); window.location.href='ui_home';</script>";
        exit();
    }
} else {
