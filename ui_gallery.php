            ...
            <div class="content-subheader">
                ...
                <div class="content-subheader__options">
                    <div class="content-subheader__search">
                        <form method="GET" action="ui_gallery.php">
                            ...
                            <?php if(!empty($search_query)): ?>
                                <a href="ui_gallery.php" class="search-clear-btn">Clear</a>
                            <?php endif; ?>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="grid__col grid__col--padding bg-white" style="border-radius:5px; margin-top: 15px;">
                        <ul class="responsive-pagination" style="display: flex; list-style: none; gap: 5px; padding-left: 0;">
                            <?php
                                ...
                                if($page > 1) {
                                    echo '<li><a href="ui_gallery.php?page='.($page - 1).$search_param.'" style="padding: 8px 12px; border: 1px solid #ddd; text-decoration: none; color: #007bff; display: inline-block; border-radius: 4px;">PREV</a></li>';
                                }
                                ...
                                for($i = 1; $i <= $total_pages; $i++) {
                                    ...
                                    echo '<li><a href="ui_gallery.php?page='.$i.$search_param.'" '.$active_class.'>'.$i.'</a></li>';
                                }

                                if($page < $total_pages) {
                                    echo '<li><a href="ui_gallery.php?page='.($page + 1).$search_param.'" style="padding: 8px 12px; border: 1px solid #ddd; text-decoration: none; color: #007bff; display: inline-block; border-radius: 4px;">NEXT</a></li>';
                                }
                            ?>
                        </ul>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close" data-bs-dismiss="modal" onclick="window.location.href='ui_gallery.php'"></button>
                </div>
    ...
    <script>
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'ui_gallery-delete.php?id=' + id;
                }
            });
        }
        ...
        function confirmEdit(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'ui_edit-gallery.php?id=' + id; 
                }
            });
        }
    </script>
