<?php
	...
	include('masterpage/sidebar.php');
	include('masterpage/navbar.php');
?>

<?php
  $fetchActiveUser = mysqli_query($conn,"SELECT * FROM user_directory WHERE email = '{$_SESSION['user']}'");
							...
							<div class="grid__col grid__col--margin grid__col--padding bg-white">
								<div class="grid__row">
									...
									<nav class="dropdown-menu dropdown-menu--content" id="moreoptions"> 			
										<ul>
											<li><a href="dashboard.php#">More Details</a></li>
											<li><a href="dashboard.php#">View Report</a></li>
											<li><a href="dashboard.php#">Edit Settings</a></li>
											<li><a href="dashboard.php#">+ Add widget</a></li>
										</ul>
									</nav>
								</div>
								...
								<div class="grid__row">
									...
									<div class="grid__col grid__col--13 grid__col--margin grid__col--padding bg-gray10 mb0">
										...
										<nav class="dropdown-menu dropdown-menu--content" id="tasksdropdown"> 			
											<ul>
												<li><a href="dashboard.php#">More Details</a></li>
												<li><a href="dashboard.php#">View Activity</a></li>
												<li><a href="dashboard.php#">Edit Settings</a></li>
												<li><a href="dashboard.php#">+ Edit widget</a></li>
											</ul>
										</nav>
									...
									<div class="grid__col grid__col--13 grid__col--margin grid__col--padding bg-gray10 mb0">
										...
										<nav class="dropdown-menu dropdown-menu--content" id="alertdropdown"> 			
											<ul>
												<li><a href="dashboard.php#">More Details</a></li>
												<li><a href="dashboard.php#">View Alerts</a></li>
												<li><a href="dashboard.php#">Edit Settings</a></li>
												<li><a href="dashboard.php#">+ Edit widget</a></li>
											</ul>
										</nav>
