...
<footer style="text-align: center; padding: 8px; font-size: 14px; font-style: sans-serif; color: #888; background: #fff; border-top: 1px solid #eee;">
    <p>&copy; <?php echo date('Y'); ?>Canossa Hospital. All Rights Reserved. Powered by <a href="https://www.aidcom.in" target="_blank"> Aidcom</a></p>
</footer>
